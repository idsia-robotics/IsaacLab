...
class QuadcopterMotorsEnvWindow(BaseEnvWindow):
    """Window manager for the Quadcopter Motors environment."""

    def __init__(self, env: QuadcopterMotorsEnv, window_name: str = "IsaacLab"):
...
class QuadcopterMotorsEnvCfg(DirectRLEnvCfg):
    ...
    ui_window_class_type = QuadcopterMotorsEnvWindow
...
class QuadcopterMotorsEnv(DirectRLEnv):
    cfg: QuadcopterMotorsEnvCfg

    def __init__(self, cfg: QuadcopterMotorsEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        propeller_max_thrust = (self.cfg.thrust_to_weight * self._robot_weight) / 4.0
